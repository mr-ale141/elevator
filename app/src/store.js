...
const slice = createSlice({
    ...
    reducers: {
        ...
        updateFlatCoordinates: (state) => {
            ...
            state.flatCoordinates.y = (5 + 10 * n) * 100000.0 + l * Math.cos(B) * (6378245.0 + 21346.1415 * Math.sin(B)**2 + 107.1590 * Math.sin(B)**4 + 0.5977 * Math.sin(B)**6 +
        ...
        updateGeographicalCoordinates: (state) => {
            ...
            const z0 = (y - (10 * n + 5) * 100000) / (6378245 * Math.cos(B0))
